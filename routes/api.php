...
Route::prefix('dashboard')->group(function () {
    ...
    Route::get('/produits-populaires', [DashboardController::class, 'getProduitsPopulaires']);
    Route::get('/promotions', [DashboardController::class, 'getPromotions']);
    Route::get('/ventes', [DashboardController::class, 'getVentes']);
});
